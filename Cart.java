...
import com.younessharaki.apricot.Database.Database;
import com.younessharaki.apricot.Model.Order;
import com.younessharaki.apricot.Model.Request;
import com.younessharaki.apricot.Viewholder.CartAdapter;
...
public class Cart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnClear.setOnClickListener(new View.OnClickListener() { //Place order Button
            @Override
        ...
        btnPlace.setOnClickListener(new View.OnClickListener() { //Place order Button
            @Override
            public void onClick(View view) {
    ...
    private void showAlertDialog() {
        ...
        alertDialog.show();//see database before submitting
